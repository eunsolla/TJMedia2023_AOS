...
import com.verse.app.databinding.FragmentTabSingPassSeasonMissionBinding
import com.verse.app.extension.customGetSerializable
import com.verse.app.ui.dialog.CommonDialog
import com.verse.app.ui.singpass.viewmodel.SingPassDashBoardSeasonViewModel
 ...
 */
@AndroidEntryPoint
class TabSingPassSeasonMissionFragment() :
    BaseFragment<FragmentTabSingPassSeasonMissionBinding, SingPassDashBoardSeasonViewModel>() {

    override val layoutId: Int = R.layout.fragment_tab_sing_pass_season_mission
    override val viewModel: SingPassDashBoardSeasonViewModel by viewModels()
    override val bindingVariable: Int = BR.viewModel

    var userMemCd: String = ""
    var seasonMngCd: String? = null

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        DLogger.d("TabSingPassSeasonMissionFragment onViewCreated")
    ...
    override fun onDestroy() {
        DLogger.d("### TabSingPassSeasonMissionFragment onDestroy")
        super.onDestroy()
    }
}