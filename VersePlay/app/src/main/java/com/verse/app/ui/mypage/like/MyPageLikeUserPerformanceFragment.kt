...
import com.verse.app.databinding.FMyPageUserPerformanceBinding
 ...
 */
@AndroidEntryPoint
class MyPageLikeUserPerformanceFragment :
    BaseFragment<FMyPageUserPerformanceBinding, MyPageLikeUserPerformanceFragmentViewModel>() {
    override val layoutId: Int = R.layout.f_my_page_user_performance
    override val viewModel: MyPageLikeUserPerformanceFragmentViewModel by viewModels()
    ...
    companion object {
        fun newInstance(data: Bundle?): Fragment {
            return MyPageLikeUserPerformanceFragment().apply {
                arguments = data
            }
        }
    }
