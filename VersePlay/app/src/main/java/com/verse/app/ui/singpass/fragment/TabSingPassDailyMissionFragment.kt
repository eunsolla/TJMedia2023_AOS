...
import com.verse.app.databinding.FragmentTabSingPassDailyMissionBinding
import com.verse.app.extension.customGetSerializable
import com.verse.app.ui.dialog.CommonDialog
import com.verse.app.ui.singpass.viewmodel.SingPassDashBoardDailyViewModel
 ...
 */
@AndroidEntryPoint
class TabSingPassDailyMissionFragment :
    BaseFragment<FragmentTabSingPassDailyMissionBinding, SingPassDashBoardDailyViewModel>() {

    override val layoutId: Int = R.layout.fragment_tab_sing_pass_daily_mission
    override val viewModel: SingPassDashBoardDailyViewModel by viewModels()
    override val bindingVariable: Int = BR.viewModel
    private val activityViewModel: SingPassDashBoardViewModel by activityViewModels()

    var userMemCd: String = ""
    var seasonMngCd: String? = ""

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        DLogger.d("TabSingPassDailyMissionFragment onViewCreated")
        ...
        with(viewModel) {
            ...
            isLoadingFinish.observe(viewLifecycleOwner){
                activityViewModel.setLoadFinished()
            }
    ...
    private fun requestSingPassMissionInfo() {
        ...
        if (viewModel.loginManager.isLogin()) {
            arguments?.let {
                ...
                seasonMngCd = it.customGetSerializable(ExtraCode.SING_PASS_SEASON_INFO)
            }
    ...
    override fun onDestroy() {
        DLogger.d("### TabSingPassDailyMissionFragment onDestroy")
        super.onDestroy()
    }
}