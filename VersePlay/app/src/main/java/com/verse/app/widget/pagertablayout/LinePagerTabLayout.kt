    ...
    init {
        ...
        if (!isInEditMode) {
            ...
            attrs?.run {
                ...
                val attr: TypedArray = ctx.obtainStyledAttributes(this, R.styleable.LinePagerTabLayout)
                ...
                try {
                    ...
                    bgColor = attr.getColor(
                        R.styleable.LinePagerTabLayout_tab_indicator_bg_color,
                        NO_ID
                    )
                    ...
                    indicatorHeight = attr.getDimension(R.styleable.LinePagerTabLayout_tab_indicator_height, -1F)
                    scrollingOffset = attr.getDimensionPixelOffset(R.styleable.LinePagerTabLayout_tab_scroll_offset, 0)
