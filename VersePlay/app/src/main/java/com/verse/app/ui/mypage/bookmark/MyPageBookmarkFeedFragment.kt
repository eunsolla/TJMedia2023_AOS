...
import com.verse.app.databinding.FMyPageBookMarkFeedBinding
...
/**
 * Description : 마이페이지 > 즐겨찾기 > [피드영상]
 *
 * Created by juhongmin on 2023/05/30
 */
@AndroidEntryPoint
class MyPageBookmarkFeedFragment :
    BaseFragment<FMyPageBookMarkFeedBinding, MyPageBookmarkFeedFragmentViewModel>() {
    override val layoutId: Int = R.layout.f_my_page_book_mark_feed
    override val viewModel: MyPageBookmarkFeedFragmentViewModel by viewModels()
    ...
    companion object {
        fun newInstance(data: Bundle?): Fragment {
            return MyPageBookmarkFeedFragment().apply {
                arguments = data
            }
        }
    }
