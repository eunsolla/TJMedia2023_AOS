...
import com.verse.app.databinding.FragmentUploadFeedBinding
import com.verse.app.ui.sing.viewmodel.SingViewModel
import com.verse.app.utility.DLogger
import dagger.hilt.android.AndroidEntryPoint

/**
 * Description : 부르기 전  준비 (파트,솔로,듀엣 선택) -> 부르기 -> 싱크 -> 업로드 -> 업로드 완료
 *
 * Created by jhlee on 2023-04-06
 */
@AndroidEntryPoint
class UploadFeedCompletedFragment : BaseFragment<FragmentUploadFeedBinding, SingViewModel>() {

    override val layoutId: Int = R.layout.fragment_upload_feed
