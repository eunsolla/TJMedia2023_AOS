...
import com.verse.app.databinding.FragmentFaqSubLastBinding
import com.verse.app.extension.popBackStackParentFragment
import com.verse.app.ui.mypage.viewmodel.FAQViewModel
import dagger.hilt.android.AndroidEntryPoint

/**
 * Description : faq 서브 -> last
 *
 * Created by esna on 2023-04-23
 */
@AndroidEntryPoint
class FAQLastFragment : BaseFragment<FragmentFaqSubLastBinding, FAQViewModel>() {

    override val layoutId: Int = R.layout.fragment_faq_sub_last
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(viewModel) {
            binding.vHeader.setHeaderTitle(subLastFAQTitle.value)
        }
    }
