...
import com.verse.app.databinding.FMyPageCollectionBinding
 ...
 */
@AndroidEntryPoint
class MyPageCollectionFragment :
    BaseFragment<FMyPageCollectionBinding, MyPageCollectionFragmentViewModel>() {
    override val layoutId: Int = R.layout.f_my_page_collection
    override val viewModel: MyPageCollectionFragmentViewModel by viewModels()
...
//            initMyPageRefresh()
    ...
    companion object {
        fun newInstance(data: Bundle?): Fragment {
            return MyPageCollectionFragment().apply {
                arguments = data
            }
        }
    }
