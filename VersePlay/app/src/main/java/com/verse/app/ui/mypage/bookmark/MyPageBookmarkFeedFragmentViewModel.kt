 ...
 */
@HiltViewModel
class MyPageBookmarkFeedFragmentViewModel @Inject constructor(
    ...
    private val queryMap: MyPageBookMarkQueryMap by lazy {
        MyPageBookMarkQueryMap().apply {
            type = FeedSubDataType.F
        }
    }
    ...
    private fun reqList() {
        ...
        repository.fetchMyPageBookmark(queryMap, this, isLoadingShow, _isRefresh.value)
