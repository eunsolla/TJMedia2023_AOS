...
import com.verse.app.databinding.FMyPagePerformanceBinding
 ...
 */
@AndroidEntryPoint
class MyPagePerformanceFragment :
    BaseFragment<FMyPagePerformanceBinding, MyPagePerformanceFragmentViewModel>() {
    override val layoutId: Int = R.layout.f_my_page_performance
    override val viewModel: MyPagePerformanceFragmentViewModel by viewModels()
...
//            initMyPageRefresh()
    ...
    companion object {
        fun newInstance(data: Bundle?): Fragment {
            return MyPagePerformanceFragment().apply {
                arguments = data
            }
        }
    }
